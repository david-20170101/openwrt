/*
 *  TP-LINK TL-WR880N v1 board support
 *
...
#define WR880NV1_GPIO_LED_WLAN			12
#define WR880NV1_GPIO_LED_SYSTEM		19
#define WR880NV1_GPIO_LED_QSS			15

#define WR880NV1_GPIO_BTN_RESET		16

#define WR880NV1_KEYS_POLL_INTERVAL		20	/* msecs */
#define WR880NV1_KEYS_DEBOUNCE_INTERVAL	(3 * WR880NV1_KEYS_POLL_INTERVAL)
...
static const char *wr880nv1_part_probes[] = {
	"tp-link",
	NULL,
};

static struct flash_platform_data wr880nv1_flash_data = {
	.part_probes	= wr880nv1_part_probes,
};

static struct gpio_led wr880nv1_leds_gpio[] __initdata = {
	{
		.name		= "tp-link:green:qss",
		.gpio		= WR880NV1_GPIO_LED_QSS,
		.active_low	= 1,
	},
	{
		.name		= "tp-link:green:system",
		.gpio		= WR880NV1_GPIO_LED_SYSTEM,
		.active_low	= 1,
	},
	{
		.name		= "tp-link:green:wlan",
		.gpio		= WR880NV1_GPIO_LED_WLAN,
		.active_low	= 1,
	},
};

static struct gpio_keys_button wr880nv1_gpio_keys[] __initdata = {
	{
		.desc		= "reset",
		.type		= EV_KEY,
		.code		= KEY_RESTART,
		.debounce_interval = WR880NV1_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= WR880NV1_GPIO_BTN_RESET,
		.active_low	= 1,
	},
};

static struct mdio_board_info wr880nv1_mdio0_info[] = {
	{
...
static void __init wr880nv1_setup(void)
{
	u8 *mac = (u8 *) KSEG1ADDR(0x1f01fc00);

	ath79_register_m25p80(&wr880nv1_flash_data);
	ath79_register_leds_gpio(-1, ARRAY_SIZE(wr880nv1_leds_gpio),
				 wr880nv1_leds_gpio);
	ath79_register_gpio_keys_polled(-1, WR880NV1_KEYS_POLL_INTERVAL,
					ARRAY_SIZE(wr880nv1_gpio_keys),
					wr880nv1_gpio_keys);
	...
	mdiobus_register_board_info(wr880nv1_mdio0_info,
				    ARRAY_SIZE(wr880nv1_mdio0_info));
...
MIPS_MACHINE(ATH79_MACH_TL_WR880N_V1, "TL-WR880N-v1",
	     "TP-LINK TL-WR880N v1",
	     wr880nv1_setup);
